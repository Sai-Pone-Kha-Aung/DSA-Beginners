"""
PROBLEM: Shortest Path in a Maze (EASY BFS)
...
def shortest_path_in_maze(maze, start, target):
    ...
    # 1. Initialize the Queue with a tuple containing (start_coordinate, distance)
    queue = deque([(start, 0)]) 
    
    # 2. Initialize your visited set to avoid loops. Add the 'start' coordinate.
    visited = {start} 
    ...
    while queue:
        ...
        for dr, dc in [(-1, 0), (1, 0), (0, -1), (0, 1)]:
            ...
            # Check boundaries, if not a wall, and if not visited
